...
//			delete connections[conn];
		...
		adapter.search = function (connectionName, collectionName, options, cb, indices) {
			...
			return collection.search(options, indices);
		};

		adapter.create = adapter.createIndex = function (connectionName, collectionName, options, cb) {
			options = options || {};
			var connectionObject = connections[connectionName],
					collection = connectionObject.collections[collectionName];
		...
		adapter.update = adapter.updateIndex = function (connectionName, collectionName, id, options, cb) {
			options = options || {};
			var connectionObject = connections[connectionName],
					collection = connectionObject.collections[collectionName];
